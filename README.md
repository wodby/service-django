# Python (Django) service for Wodby

Use Python (Django) as a reusable component in applications managed by Wodby.
This repository contains the service manifests and referenced files used by the
public Python (Django) service in the Wodby catalog.
...
| Application build | Git source connection enabled; Dockerfile: `Dockerfile`; starters: Django boilerplate |
...
4. Reference `django` from your stack manifest.
